  ...
  return (
    ...
    <Navbar/>
        ...
        <Link
            ...
            to="e_messages"
            className={`flex items-center w-full mt-3 py-3 px-4 ${location.pathname === "/e_messages" ? 'bg-whatsapp-green text-white' : 'hover:bg-whatsapp-green text-green-900'} font-custom rounded-md text-decoration-none mb-2`}
      ...
      <p className="text-gray-400 ml-10 mt-0">&copy; 2025 SKILL LAB</p>
    </div>
  );
}
